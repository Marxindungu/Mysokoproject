package com.example.project_one.data
...
import com.example.project_one.modules.Upload
import com.example.project_one.navigation.ROUTE_LOGIN
...
class ProductRepository(var navController: NavHostController, var context: Context) {
    ...
    fun saveProduct(productName:String, productNumber:String, productQuantity:String, productPrice:String){
        var id = System.currentTimeMillis().toString()
        var productData = Product(productName,productNumber,productQuantity,productPrice,id)
    ...
    fun uploadProduct(name:String, number:String, quantity:String, price:String,id:String){
        var updateRef = FirebaseDatabase.getInstance().getReference()
            .child("Products/$id")
        progress.show()
        var updateData = Product(name, number, quantity, price, id)
